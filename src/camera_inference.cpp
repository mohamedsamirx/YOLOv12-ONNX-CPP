 ...
 * @brief Real-time object detection using YOLOv12 with camera input.
 * 
 * This file serves as the main entry point for a real-time object detection 
 * application that utilizes YOLO (You Only Look Once) model, specifically 
 * version 12. The application captures video frames from a 
